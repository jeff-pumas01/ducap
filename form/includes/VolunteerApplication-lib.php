...
class FM_DateObj
{
    ...
    function FM_DateObj(&$formvars,&$config,&$logger)
    {
...
class FM_SubmissionSerializer
{
    ...
    function FM_SubmissionSerializer(&$config,&$logger,&$error_handler,$tablename)
    {
       $this->tablename = $tablename;
    ...
    function GetSerializedData($id)
    {
        ...
        $result = mysql_query($qry,$this->dbutil->GetConnection() );
    ...
    function InsertIntoTable($var_array)
    {
        ...
        if(!mysql_query($qry,$this->dbutil->GetConnection()))
        {
            $this->dbutil->HandleError('Error inserting data to the table '.$this->tablename,"\nquery:$qry");
            return false;
        } 
        return mysql_insert_id($this->dbutil->GetConnection());
    }
